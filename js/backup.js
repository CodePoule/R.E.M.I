...
function alertMsgImpromptu() {
    ...
    if (x == 5) {
        ...
        let titreDialog = $('.ui-dialog-titlebar'); // Titre Boite Dialogue JQuery UI
        titreDialog.hide();
        pad.hide();
        touches = 0;
    }
...
// Appels des fonctions de déplacement
down(bas);
up(haut);
left(gauche);
right(droite);
